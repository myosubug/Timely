...
const LandingPage = (props) => {
    ...
    function checkModalState() {
        if (renderModalObj.post) {
            return renderModal(<PostCreator onCancel = {cancelModal.bind("post")} />);
        } else if (renderModalObj.tags) {
            return renderModal(<PostCreator onCancel = {cancelModal.bind("tags")} />);
        } else if (renderModalObj.login) {
            return renderModal(<PostCreator onCancel = {cancelModal.bind("login")} />);
        }
    }
